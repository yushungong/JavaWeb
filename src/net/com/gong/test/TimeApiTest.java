...
public class TimeApiTest {
	...
	public static void main(String[] args) throws ParseException {
	    ...
	    try  
	    {  
	      // 对 calendar 设置时间的方法  1:传入指定时间的Date对象
	      // 设置传入的时间格式  
	    ...
	    // 或者另一種設置 calendar 方式  2：分别传入指定时间的年月日时分秒int值
	    ...
	    // 设定为 5 小时以前，后者大，显示 -1  
	    calendarNew.add(Calendar.DATE, -5);  
	    System.out.println("时间比较：" + calendarNew.compareTo(calendar)); 
	    
	    //要计算时间差，可用 Calendar.getTimeInMillis() 取得两个时间的微秒级的时间差，再加以换算即可，比如获得相差天数
		// 得微秒级时间差  
		long val = calendar.getTimeInMillis() - calendarNew.getTimeInMillis();  
		// 换算后得到天数  
		long day = val / (1000L * 60L * 60L * 24L);
